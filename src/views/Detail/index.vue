    ...
    <div class="container" v-if="detailList.details">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/${detailList.categories?.[0].id}` }">{{ detailList.categories?.[0].name }}
          </el-breadcrumb-item>
        ...
        <div>
          <div class="goods-info">
            ...
            <div class="spec">
              ...
              <!-- sku组件 -->
              <XtxSku :goods="detailList"></XtxSku>
              <!-- 数据组件 -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                     <img v-for="(i, index) in detailList.details.pictures" :key="index" :src="i" alt="">
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
